...
const outlineIcons: Record<string, IconComponent> = {
  ...
  ArrowRightIcon,
  ArrowRightStartOnRectangleIcon,
  ArrowRightOnRectangleIcon: ArrowRightStartOnRectangleIcon, // Backward compat alias
  ArrowsPointingInIcon,
  ArrowsPointingOutIcon,
  ArrowTopRightOnSquareIcon,
  ArrowUpIcon,
...
const solidIcons: Record<string, IconComponent> = {
  ...
  ArrowRightStartOnRectangleIcon: ArrowRightStartOnRectangleIconSolid,
  ArrowRightOnRectangleIcon: ArrowRightStartOnRectangleIconSolid, // Backward compat alias
  ...
  ArrowUturnLeftIcon: ArrowUturnLeftIconSolid,
  ...
  DocumentArrowDownIcon: DocumentArrowDownIconSolid,
  CreditCardIcon: CreditCardIconSolid,
  CurrencyDollarIcon: CurrencyDollarIconSolid,
  ...
  MinusCircleIcon: MinusCircleIconSolid,
  NoSymbolIcon: NoSymbolIconSolid,
