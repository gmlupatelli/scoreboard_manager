...
export default function DangerZoneSection({ onDeleteAccount }: DangerZoneSectionProps) {
  ...
  return (
    <div className="bg-card rounded-lg elevation-1 p-6 border-2 border-red-500/30">
        ...
        <div className="space-y-4">
          ...
          <div className="flex gap-3">
            ...
            <button
              ...
              disabled={deleting}
              className="px-6 py-3 bg-muted text-text-secondary rounded-lg hover:bg-muted/80 disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:bg-muted transition-smooth font-medium"
