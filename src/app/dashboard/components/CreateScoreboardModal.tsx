...
export default function CreateScoreboardModal({ isOpen, onClose, onCreate }: CreateScoreboardModalProps) {
        ...
        <div className="fixed inset-0 flex items-center justify-center z-[1011] p-4 pointer-events-none">
          ...
          >
            <div className="flex items-center justify-between mb-6 landscape-mobile:mb-3">
              <h2 id="create-scoreboard-title" className="text-xl font-semibold text-text-primary">Create New Scoreboard</h2>
              <button
                type="button"
                onClick={handleClose}
