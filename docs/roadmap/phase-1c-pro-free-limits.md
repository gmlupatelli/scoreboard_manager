...
### Issue 1c.5: Display Usage Information

**Title:** Show usage stats in dashboard/settings

**Description:**
Display clear usage information to users:
1. Current scoreboard count vs limit
2. Entry counts per scoreboard
3. Visual progress indicators
4. Upgrade prompts when approaching limits

**Acceptance Criteria:**
- [ ] Usage widget in dashboard
- [ ] Shows X of Y scoreboards used
- [ ] Progress bar visualization
- [ ] Warning state when approaching limit (80%+)
- [ ] Link to upgrade when at limit
